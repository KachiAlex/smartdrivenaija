...
export function Logo({ className = "", size = 120 }: { className?: string; size?: number }) {
  return (
    ...
    >
      ...
      >
        <circle cx="55" cy="70" r="16" fill="#22C55E" />
      ...
      {/* Bottom red accent */}
      <path d="M100 210 Q130 195 145 175 L100 190 L55 175 Q70 195 100 210Z" fill="#15803D" opacity="0.9" />
    </motion.svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 mt-1">
        ...
        />
        <span
          className="text-[#15803D] text-lg font-extrabold tracking-[0.2em]"
          style={{ fontFamily: "Poppins" }}
        >
          NAIJA
        </span>
