  ...
  return (
    <div className="min-h-screen bg-[#0A1F12] pb-24">
      ...
      <div className="px-4 -mt-4 relative z-20 space-y-4">
        {/* SOS Button */}
        <Card className="p-6 glass-card border-2 border-[#15803D]/30">
        ...
        <div className="grid grid-cols-2 gap-3">
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
            <Card className="p-4 glass-card border-white/10 cursor-pointer">
              <div className="flex flex-col items-center text-center">
                <div className="w-12 h-12 rounded-full flex items-center justify-center bg-[#22C55E]/20 mb-3">
          ...
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
            <Card className="p-4 glass-card border-white/10 cursor-pointer" onClick={() => onNavigate("first-aid")}>
              <div className="flex flex-col items-center text-center">
                <div className="w-12 h-12 rounded-full flex items-center justify-center bg-[#22C55E]/20 mb-3">
                  <HeartPulse className="w-6 h-6 text-[#22C55E]" />
                </div>
                <h4 className="text-white font-medium text-sm mb-1" style={{ fontFamily: "Poppins" }}>
                  First Aid
                </h4>
        ...
        {/* Safety Info */}
        <Card className="p-4 glass-card border-[#22C55E]/20">
