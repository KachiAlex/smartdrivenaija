  ...
  return (
    <div className="size-full overflow-auto bg-[#F0FDF4] pb-28">
      ...
      <div className="relative p-6 pb-12 rounded-b-[2.5rem] overflow-hidden"
        style={{ background: passed ? "linear-gradient(135deg, #15803D 0%, #22C55E 40%, #0A1F12 100%)" : "linear-gradient(135deg, #4B7C5F 0%, #94A3B8 100%)" }}
      >
        {/* Animated mesh blobs */}
        <motion.div
      ...
      <div className="p-6 space-y-6 -mt-4 relative z-10">
        ...
        >
          <h3 className="mb-4 text-[#14532D] font-bold">Quick Stats</h3>
          <div className="grid grid-cols-2 gap-3">
            <Card className="p-4 glass-card border-[#15803D]/10">
              <div className="flex items-center gap-3 mb-2">
                <CheckCircle className="w-5 h-5 text-[#15803D]" />
                <span className="text-sm text-[#4B7C5F]">Correct</span>
              </div>
              <p className="text-[#14532D]" style={{ fontWeight: 700, fontSize: "1.5rem", fontFamily: "Poppins" }}>
            ...
            <Card className="p-4 glass-card border-red-400/10">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-sm text-[#4B7C5F]">Wrong</span>
              </div>
              <p className="text-[#14532D]" style={{ fontWeight: 700, fontSize: "1.5rem", fontFamily: "Poppins" }}>
          ...
          {xpEarned > 0 && (
            <Card className="p-4 mt-3 glass-card border-[#22C55E]/10">
              <div className="flex items-center justify-between">
                <span className="text-sm text-[#4B7C5F]">XP Earned</span>
                <span className="text-[#22C55E]" style={{ fontWeight: 700, fontSize: "1.5rem", fontFamily: "Poppins" }}>+{xpEarned}</span>
              </div>
            </Card>
          )}
        </motion.div>
        ...
        {topicPerformance.length > 0 && (
          ...
          >
            <h3 className="mb-4 text-[#14532D] font-bold">Topic Performance</h3>
            <Card className="p-6 glass-card border-[#15803D]/10">
        ...
        {weakAreas.length > 0 && (
          ...
          >
            <h3 className="mb-4 text-[#14532D] font-bold">Weak Areas</h3>
            <Card className="p-4 space-y-4 glass-card border-[#15803D]/10">
              {weakAreas.map((area: any, i: number) => (
                <div key={i}>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-[#14532D]">{area.topic.replace(/_/g, ' ')}</span>
                    <span className="text-sm text-[#4B7C5F]">{area.percentage}%</span>
                  </div>
        ...
        >
          <h3 className="mb-4 text-[#14532D] font-bold">Recommended Next Steps</h3>
          <Card className="p-4 glass-card border-[#22C55E]/10">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h4 className="mb-1 text-[#14532D] font-semibold">Review Safety Module</h4>
                <p className="text-sm text-[#4B7C5F] mb-3">
                  Focus on First Aid & Accident Response to improve your score
                </p>
                <Button variant="outline" size="sm" onClick={() => onNavigate("modules")} className="border-[#15803D]/30 text-[#15803D]">
                  Go to Module
                </Button>
              </div>
            </div>
        ...
        >
          {passed && (
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Button onClick={() => onNavigate("certificate")} className="w-full h-12 shadow-lg shadow-[#15803D]/20" size="lg"
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button onClick={handleWhatsAppShare} variant="outline" className="h-12 border-[#15803D]/30 text-[#15803D]">
              <MessageCircle className="w-5 h-5 mr-2" />
              WhatsApp
            </Button>
            <Button onClick={() => onNavigate("home")} variant="outline" className="h-12 border-[#15803D]/30 text-[#15803D]">
              Home
            </Button>
          </div>
        </motion.div>
