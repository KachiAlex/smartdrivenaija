  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col bg-[#0A1F12] overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-[5%] right-[5%] w-64 h-64 rounded-full bg-[#15803D]/20 blur-[80px]"
      />
      <motion.div
        animate={{ scale: [1, 1.15, 1], opacity: [0.06, 0.12, 0.06] }}
        transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
        className="absolute top-[15%] left-[10%] w-48 h-48 rounded-full bg-[#22C55E]/15 blur-[60px]"
      />
      ...
      >
        ...
        >
          ...
          <span className="text-sm font-semibold text-[#14532D]" style={{ fontFamily: "Poppins" }}>
            {email || phoneNumber}
          </span>
        </motion.div>
        ...
        >
          {canResend ? (
            <button
              ...
              className="text-[#15803D] text-sm font-semibold hover:underline transition-all"
            >
              Resend Code
            </button>
          ) : (
            <p className="text-sm text-[#4B7C5F]">
              Resend code in <span className="font-semibold text-[#14532D]" style={{ fontFamily: "Poppins" }}>{timer}s</span>
            </p>
          )}
        </motion.div>
        ...
        <motion.div
          ...
          className="flex items-start gap-3 p-3 rounded-xl bg-[#F0FDF4] border border-[#BBF7D0] mb-6"
        >
