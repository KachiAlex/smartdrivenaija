...
export function WalletScreen({ onNavigate }: { onNavigate: (screen: string) => void }) {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case "expiring":
        return "bg-[#22C55E]/20 text-[#15803D] border-[#22C55E]/30";
      case "expired":
  ...
  return (
    <div className="min-h-screen bg-[#0A1F12] pb-24">
      ...
      <div className="px-4 -mt-4 relative z-20">
        ...
        <AnimatePresence>
          {reminders.filter(r => !r.is_read).length > 0 && (
            <motion.div
              ...
              className="mb-6"
            >
              <Card className="p-4 glass-card border-2 border-[#22C55E]/30">
        ...
        <Card className="p-5 glass-card border-2 border-[#15803D]/20 mb-6">
              ...
              >
                <Card className="p-4 glass-card border-white/10">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-full flex items-center justify-center bg-[#15803D]/20">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        {doc.required && (
                          <Badge className="text-xs bg-[#15803D]/20 text-[#15803D] border-[#15803D]/30">
                            Required
                          </Badge>
                        )}
                      </div>
        ...
        <motion.div
          ...
          className="mt-4"
        >
          <Card className="p-4 glass-card border-dashed border-2 border-white/20 cursor-pointer hover:border-[#15803D]/50 transition-colors">
        ...
        {/* Info Card */}
        <Card className="p-4 glass-card border-[#22C55E]/20 mt-6">
          <div className="flex items-start gap-3">
            <div className="w-8 h-8 rounded-full flex items-center justify-center bg-[#22C55E]/20 flex-shrink-0">
