...
export function LanguageSelectionScreen({ onComplete }: LanguageSelectionScreenProps) {
  ...
  return (
    <div className="size-full flex flex-col bg-[#F0FDF4] p-6 pb-24">
      <motion.div
      ...
      <div className="fixed bottom-0 left-0 right-0 p-6 bg-[#F0FDF4] border-t border-[#BBF7D0]">
        <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
          <Button onClick={handleComplete} className="w-full h-12 shadow-lg shadow-[#15803D]/20" size="lg" disabled={isSaving}
