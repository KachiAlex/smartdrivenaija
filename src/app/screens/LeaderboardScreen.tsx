...
export function LeaderboardScreen() {
  ...
  return (
    <div className="size-full flex flex-col bg-background pb-24">
      <div className="bg-gradient-to-br from-accent/20 to-primary/20 p-6 pb-6">
        <motion.div
          ...
          <TabsContent value={activeTab} className="space-y-3">
            {loading.leaderboard ? (
              ...
              data.map((user, index) => (
                ...
                >
                  <Card className={`p-4 ${user.isCurrentUser ? "border-primary bg-primary/5" : ""}`}>
                    <div className="flex items-center gap-4">
                      ...
                      <Avatar className={`${user.rank <= 3 ? "w-12 h-12" : "w-10 h-10"}`}>
                        <AvatarFallback className={user.rank === 1 ? "bg-accent text-accent-foreground" : user.rank === 2 ? "bg-gray-200" : user.rank === 3 ? "bg-amber-100" : ""}>
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <p className="font-heading" style={{ fontWeight: 600 }}>{user.name}</p>
                      ...
                      <div className="text-right">
                        <div className="flex items-center gap-1 text-accent-foreground mb-1">
                          ...
                          <span className="font-heading" style={{ fontWeight: 700 }}>{user.xp}</span>
                        </div>
            ...
            {currentUserRank && currentUserRank > data.length && (
              ...
              >
                <Card className="p-4 border-primary bg-primary/5">
                  <div className="flex items-center gap-4">
                    <div className="flex items-center justify-center w-10">
                      <span className="text-muted-foreground font-heading" style={{ fontWeight: 600 }}>#{currentUserRank}</span>
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        <p className="font-heading" style={{ fontWeight: 600 }}>Your Rank</p>
