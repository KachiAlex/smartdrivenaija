...
export function OnboardingScreen({ onComplete }: OnboardingScreenProps) {
    ...
    >
      ...
      <div className="mt-auto mb-24 px-8 text-center max-w-sm">
        ...
        >
          ...
          <br />
          Drive{" "}
          <span className="text-[#22C55E]">{slide.highlightWord}</span>
        </motion.h2>
        <motion.p
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-5">
          <span
            className="text-[#15803D] text-sm font-bold"
            style={{ fontFamily: "Poppins" }}
          >
            {slide.number}
          </span>
          <div className="flex-1 h-[1px] bg-[#BBF7D0]" />
        </div>

        {/* Title */}
        <h2
          className="text-[#14532D] text-[1.5rem] font-bold leading-tight mb-3"
          style={{ fontFamily: "Poppins" }}
        >
          {slide.title}
        </h2>
        ...
        {/* Description */}
        <p className="text-[#4B7C5F] text-[0.95rem] leading-relaxed mb-8">
          {slide.description}
        </p>
          ...
          <div className="flex gap-2" role="tablist" aria-label="Onboarding slides">
            {SLIDES.map((_, index) => (
              <button
                ...
                className="transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#15803D] rounded-full"
                role="tab"
              ...
              >
                <motion.div
                  ...
                  animate={{
                    ...
                    backgroundColor: index === currentSlide ? "#15803D" : "#BBF7D0",
                  }}
  ...
  return (
    <div
      ref={containerRef}
      className="fixed inset-0 z-[100] flex flex-col bg-[#0A1F12] overflow-hidden"
      role="region"
    ...
    >
      ...
      {/* Loading overlay */}
      <motion.div
        className="absolute inset-0 z-[60] bg-[#0A1F12] flex items-center justify-center"
        initial={{ opacity: 1 }}
        ...
        <motion.button
          ...
          className={`text-sm font-medium transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white rounded px-2 py-1 ${
            slide.hasDarkBg
              ...
              : "text-[#14532D]/70 hover:text-[#14532D] focus-visible:ring-[#15803D]"
          }`}
          whileTap={{ scale: 0.95 }}
          ...
          {SLIDES.map((_, index) => (
            ...
            >
              <motion.div
                ...
                animate={{
                  width: index === currentSlide ? 24 : 8,
                  backgroundColor: index === currentSlide ? "#15803D" : "rgba(255,255,255,0.4)",
                }}
                transition={shouldReduceMotion ? instantTransition : { duration: 0.3, ease: "easeInOut" }}
                style={{ height: 8 }}
              />
